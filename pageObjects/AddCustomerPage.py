...
class AddCustomerPage:
    ...
    # one action method for each element
    def clickOnCustomersMenu(self):
        self.driver.find_element_by_xpath(self.lnkCustomers_menu_xpath).click()

    def clickOnCustomersMenuItem(self):
        element = self.driver.find_element_by_xpath(self.lnkCustomers_menuitem_xpath)
    ...
    def setCustomerRoles(self, role):
        select_inputs = self.driver.find_elements_by_xpath(self.txtcustomerRoles_xpath)
